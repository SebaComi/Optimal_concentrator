...
switch MESH.dim
    ...
    case 3
        ...
        if ~isempty(MESH.Robin_side)
            ...
            u_Robin = DATA.bcRob_fun(xlt,ylt,zlt,t,param);
            alphaR  = DATA.bcRob_alpha(xlt,ylt,zlt,t,param);
            ...
            for l = 1 : nof
                ...
                alphaR_loc   = repmat(alphaR(l,:).*wi, nbn,1);
                ...
                Arows(1+(l-1)*nbn*nbn:l*nbn*nbn)   =  MESH.boundaries(rows,face);
                Acols(1+(l-1)*nbn*nbn:l*nbn*nbn)   =  MESH.boundaries(cols,face);
                Acoef(1+(l-1)*nbn*nbn:l*nbn*nbn)   =  detjac * (alphaR_loc.*phi)*phi';
